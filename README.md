...
Here I post articles and notes on various topics, including analytical chemistry, method development, mass spectrometry, and data analytics. The goal of this site is to provide a resource for professionals and enthusiasts in the field of analytical chemistry and related disciplines. 
...
If you'd like to contribute to this site, please fork the repo, create a new branch, and submit a pull request with your changes. For major changes, please open an issue first to discuss what you would like to change.
...
You can reach me using the contact form on the [Contact page](/contact/). I welcome inquiries regarding consulting, speaking engagements, research collaborations, or questions about my open-source tools. Please use the form and I will respond as soon as possible.
